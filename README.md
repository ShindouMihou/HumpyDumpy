...
| from      | user snowflake (id)                                 |     ✔️    | 584322030934032393                                                                                         | When using `before` or `after` parameter then this will be ignored.                          |
| to        | user snowflake (id)                                 |     ✔️    | 584322030934032393                                                                                         | When using `before` or `after` parameter then this will be ignored.                          |
